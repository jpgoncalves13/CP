...
&
    A \times (\ensuremath{\Conid{Rose}\;\Conid{A}})^*
           \ar[d]^{\ensuremath{(\Conid{RecRose}\;\llparenthesis\, \Varid{gr2l}\,\rrparenthesis_\textit{\tiny R})}}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{gsq1}\;(((\Varid{x},\Varid{y}),\Varid{z}),\Varid{w})\mathrel{=}((\Varid{x}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{gsq2}\;(((\Varid{x},\Varid{y}),\Varid{z}),\Varid{w})\mathrel{=}\mathbf{if}\;\Varid{w}\mathbin{>}\mathrm{0}\;\mathbf{then}\;[\mskip1.5mu (((\Varid{x},\Varid{y}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),{}\<[63]%
\>[63]{}(((\Varid{x}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3},\Varid{y}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),{}\<[87]%
\>[87]{}(((\Varid{x}\mathbin{+}(\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{y}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),(((\Varid{x},\Varid{y}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),(((\Varid{x},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),(((\Varid{x}\mathbin{+}\Varid{z}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1}),(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{z}\mathbin{/}\mathrm{3}),\Varid{z}\mathbin{/}\mathrm{3}),\Varid{w}\mathbin{-}\mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[9]{}\hsindent{21}{}\<[30]%
\>[30]{}\mathbf{else}\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{present}\mathrel{=}\Varid{mmap}\;(\mathbin{\$\char92 \$}\Varid{l}\to \mathbf{do}\;\{\mskip1.5mu \Varid{drawSq}\;\Varid{l};\Varid{await}\mskip1.5mu\}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
