...
\xymatrix{
  ...
  (Square,N_0)\ar@/_1.5pc/[rr]_{\ensuremath{\Varid{gsq}}}\ar[r]^(0.55){\ensuremath{\Varid{outNat}\comp \p2}}\ar[u]^{\ensuremath{\lanabracket\;\!\Varid{gsq}\;\!\ranabracket_\textit{\tiny R}}} & 1+(N_0)\ar[r]^(0.35){\cdots} & Square\times (Square,N_0)^*\ar[u]_{\ensuremath{(\Conid{RecRose}\;\llparenthesis\, \Varid{gr2l}\,\rrparenthesis_\textit{\tiny R})}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cgene}\mathrel{=}\alt{c_1 }{c_2 }{}\<[E]%
\\
\>[B]{}c_1 \mathrel{=}\Varid{nil}{}\<[E]%
\\
\>[B]{}c_2 \;((\Varid{a},\Varid{b}),[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}c_2 \;((\Varid{a},\Varid{b}),(a_1 ,b_1 )\mathbin{:}\Varid{t})\mathrel{=}\mathbf{if}\;\Varid{a}\equiv a_1 \;\mathbf{then}\;(a_1 ,b_1 \mathbin{+}\Varid{b})\mathbin{:}\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mathbf{else}\;(a_1 ,b_1 )\mathbin{:}c_2 \;((\Varid{a},\Varid{b}),\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{glt}\;\Varid{l}\mathrel{=}i_2\;(\Varid{take}\;\Varid{n}\;\Varid{l},\Varid{drop}\;\Varid{n}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{n}\mathrel{=}\length \;\Varid{l}\div \mathrm{2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
